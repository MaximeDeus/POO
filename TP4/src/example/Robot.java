 ...
 * 
 * @author pierrick meignant et maxime Deroissart
 * @version 1.0
 */
...
public class Robot {
	...
	if (this.carryBox() && belt.accept(this.carriedBox) && !belt.isFull()) {
	    // put box on belt
    ...
    /**
     * Test function in robot with four box and two belt. It looks the belt.
     * @param args The list with arguments in terminal.
     */
